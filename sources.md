...
本仓库的日报以技术新闻为主，优先关注模型、API、开源、论文、开发者工具、AI agent、图像/视频/多模态生成、算力基础设施和安全评估。

## 时间规则

- 每天北京时间 06:00 整理前一天的新闻。
- 只收录目标日期当天发布或实质更新的内容；跨时区来源按页面标注的本地发布日期判断。
- 目标是最多 30 条；不用目标日期以前的旧闻补齐数量，如果合格内容不足 30 条，就少发。
- 无法确认发布时间或页面日期早于目标日期的内容不进入日报。
...
- Adobe Blog AI：https://blog.adobe.com/en/topics/ai
- Black Forest Labs Blog：https://bfl.ai/blog
- Luma AI Blog：https://lumalabs.ai/blog
- Midjourney Updates：https://updates.midjourney.com/
- Pika Blog：https://pika.art/blog
- Ideogram Blog：https://about.ideogram.ai/
...
- Pika Blog：https://pika.art/blog
- Ideogram Blog：https://about.ideogram.ai/
- Adobe AI Blog：https://blog.adobe.com/en/topics/ai
- Google DeepMind Visual AI：https://deepmind.google/discover/blog/
